      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-medium rounded-xl p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-text-tertiary">Total Invoices</h3>
            <FileText className="w-5 h-5 text-primary" />
          </div>
          <p className="text-3xl font-bold text-text-primary">{filteredInvoices.length}</p>
        </div>

        <div className="glass-medium rounded-xl p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-text-tertiary">Total Amount</h3>
        ...
        <div className="glass-medium rounded-xl p-6 border border-white/10">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-text-tertiary">Paid Amount</h3>
            <DollarSign className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-blue-400">{formatCurrency(paidAmount)}</p>
        </div>
      </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg glass-light border border-white/10 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
          <select
            value={statusFilter}
            onChange={(e) => setStatusFilter(e.target.value)}
            className="px-4 py-2 rounded-lg glass-light border border-white/10 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
          >
          ...
          <table className="w-full">
            <thead className="glass-subtle">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-text-tertiary uppercase">Project</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-text-tertiary uppercase">Issue Date</th>
                ...
                <tr key={invoice.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <button className="p-1 hover:bg-white/10 rounded transition-colors" title="Delete">
