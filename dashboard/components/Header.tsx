    ...
    <>
      <header className="sticky top-0 z-40 glass-medium border-b border-white/10">
        <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 gap-4">
          {/* Scrollable container with Team Selector, Tabs, and Search */}
          <div
          ...
          >
            ...
            <div className="relative flex items-center flex-shrink-0">
              ...
              <input
                ...
                className="glass-medium border border-white/10 pl-10 pr-4 py-2 rounded-lg text-text-primary placeholder:text-text-tertiary text-sm w-48 focus:w-64 focus:border-primary/50 focus:outline-none transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)]"
              />
            </div>
          </div>
