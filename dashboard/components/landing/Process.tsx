...
export function Process() {
    return (
        <section className="w-full bg-[#050505] relative py-24 lg:py-32 border-t border-foreground/5 overflow-hidden">
            {/* Background Pattern */}
            <div
            ...
            <div className="w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center relative z-10">
                ...
                <div className="relative w-full aspect-square max-w-lg mx-auto lg:max-w-none flex items-center justify-center [animation:fadeSlideIn_0.8s_ease-out_0.2s_both] animate-on-scroll animate">
                    ...
                    <div className="relative w-64 h-64 sm:w-80 sm:h-80">
                        ...
                        <div className="absolute inset-0 z-0 translate-y-24 transition-transform duration-700 hover:translate-y-28 group">
                            <div className="w-full h-full border border-foreground/10 bg-white/[0.02] backdrop-blur-[2px] rotate-45 scale-y-50 shadow-2xl transition-colors group-hover:border-[#FACC15]/30"></div>
                            {/* Label Right */}
                            <div className="absolute top-1/2 -right-12 sm:-right-24 -translate-y-1/2 translate-x-4 flex items-center gap-3 opacity-0 lg:opacity-100 transition-opacity duration-500 delay-300">
                                <div className="px-3 py-1.5 rounded-full border border-foreground/10 bg-[#080808] flex items-center gap-2 shadow-xl">
                                ...
                                <div className="w-12 h-[1px] bg-foreground/10 origin-left -rotate-[25deg]"></div>
                            </div>
                        </div>

                        {/* Layer 03 */}
                        <div className="absolute inset-0 z-10 translate-y-12 transition-transform duration-700 hover:translate-y-14 group">
                            <div className="w-full h-full border border-foreground/10 bg-foreground/[0.04] backdrop-blur-[2px] rotate-45 scale-y-50 shadow-2xl transition-colors group-hover:border-[#FACC15]/30"></div>
                            {/* Label Left */}
                            <div className="absolute top-1/2 -left-12 sm:-left-24 -translate-y-1/2 -translate-x-4 flex flex-row-reverse items-center gap-3 opacity-0 lg:opacity-100 transition-opacity duration-500 delay-200">
                                ...
                                <div className="w-12 h-[1px] bg-foreground/10 origin-right rotate-[25deg]"></div>
                            </div>
                        </div>

                        {/* Layer 02 */}
                        <div className="absolute inset-0 z-20 translate-y-0 transition-transform duration-700 hover:-translate-y-2 group">
                            <div className="w-full h-full border border-foreground/10 bg-white/[0.06] backdrop-blur-[2px] rotate-45 scale-y-50 shadow-2xl transition-colors group-hover:border-[#FACC15]/30"></div>
                            {/* Label Right */}
                            <div className="absolute top-1/2 -right-12 sm:-right-24 -translate-y-1/2 translate-x-4 flex items-center gap-3 opacity-0 lg:opacity-100 transition-opacity duration-500 delay-100">
                                <div className="px-3 flex items-center gap-2 shadow-xl">
                                    ...
                                    <div className="w-8 h-4 bg-[#FACC15] rounded-full relative">
                                        <div className="absolute right-0.5 top-0.5 bottom-0.5 w-3 bg-background rounded-full"></div>
                                    </div>
                                </div>
                                <div className="w-12 h-[1px] bg-foreground/10 origin-left -rotate-[25deg]"></div>
                            </div>
                        ...
                        <div className="absolute inset-0 z-30 -translate-y-12 transition-transform duration-700 hover:-translate-y-16 group">
                            <div className="w-full h-full border border-foreground/10 bg-white/[0.08] backdrop-blur-[2px] rotate-45 scale-y-50 shadow-2xl transition-colors group-hover:border-[#FACC15]/50 hover:bg-foreground/10"></div>
                            {/* Label Left */}
                ...
                <div className="flex flex-col justify-center [animation:fadeSlideIn_0.8s_ease-out_0.4s_both] animate-on-scroll animate">
                    <h2 className="text-4xl lg:text-6xl font-light text-foreground tracking-tight leading-[1.1] mb-6">
                        From Algorithm
                    ...
                    <div className="relative space-y-12 pl-2">
                        ...
                        <div className="relative flex gap-8 group cursor-default">
                            <div className="relative z-10 shrink-0">
                                <div className="w-10 h-10 rounded-full bg-[#080808] border border-foreground/10 flex items-center justify-center group-hover:border-[#FACC15] group-hover:text-[#FACC15] transition-all duration-300">
                                    <iconify-icon icon="solar:magnifer-bold-duotone" width="20"></iconify-icon>
                                </div>
                            </div>
                            <div className="pt-1">
                                <h3 className="text-xl text-foreground font-normal mb-2 group-hover:text-[#FACC15] transition-colors">Site &amp; Context Analysis</h3>
                        ...
                        <div className="relative flex gap-8 group cursor-default">
                            ...
                            <div className="pt-1">
                                <h3 className="text-xl text-foreground font-normal mb-2 group-hover:text-[#FACC15] transition-colors">Parametric Synthesis</h3>
                                <p className="text-neutral-500 font-light leading-relaxed">
                        ...
                        <div className="relative flex gap-8 group cursor-default">
                            ...
                            <div className="pt-1">
                                <h3 className="text-xl text-foreground font-normal mb-2 group-hover:text-[#FACC15] transition-colors">BIM Integration</h3>
                                <p className="text-neutral-500 font-light leading-relaxed">
                        ...
                        <div className="relative flex gap-8 group cursor-default">
                            ...
                            <div className="pt-1">
                                <h3 className="text-xl text-foreground font-normal mb-2 group-hover:text-[#FACC15] transition-colors">Robotic Fabrication</h3>
                                <p className="text-neutral-500 font-light leading-relaxed">
                    ...
                    <div className="mt-16 pt-10 border-t border-foreground/5">
                        ...
                        <div className="flex flex-wrap gap-8 items-center opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
                            <iconify-icon icon="simple-icons:autodesk" width="24" className="hover:text-foreground transition-colors"></iconify-icon>
                            <iconify-icon icon="simple-icons:rhinoceros" width="28" className="hover:text-foreground transition-colors"></iconify-icon>
                            <iconify-icon icon="simple-icons:unrealengine" width="24" className="hover:text-foreground transition-colors"></iconify-icon>
                            <iconify-icon icon="simple-icons:blender" width="24" className="hover:text-foreground transition-colors"></iconify-icon>
                            <iconify-icon icon="cib:adobe-creative-cloud" width="26" className="hover:text-foreground transition-colors"></iconify-icon>
                        </div>
                    </div>
                </div>
            </div>
