    ...
    return (
        <section className="overflow-hidden lg:py-32 bg-[#050505] w-full z-10 border-white/5 border-t my-12 pt-24 pb-24 relative">
            ...
            <div className="w-full px-6 lg:px-12 flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8 [animation:fadeSlideIn_0.8s_ease-out_0.2s_both] animate-on-scroll animate">
                <h2 className="text-5xl lg:text-7xl font-normal text-foreground tracking-tighter leading-[0.9] uppercase">
                    System 2.0.
                    <span className="text-neutral-500">New Logic.</span>
                </h2>

                <a href="#" className="group flex items-center gap-4 text-xs font-medium text-foreground hover:text-[#FACC15] transition-colors uppercase tracking-widest pb-2 border-b border-foreground/10 hover:border-[#FACC15]">
                    Explore Interface
            ...
            <div className="w-full overflow-x-auto pb-12 px-6 lg:px-12 flex gap-6 snap-x snap-mandatory scrollbar-hide [animation:fadeSlideIn_1s_ease-out_0.3s_both] animate-on-scroll animate" style={{ msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
                ...
                <div className="snap-center shrink-0 w-[300px] md:w-[360px] group cursor-default">
                    <div className="aspect-[4/5] overflow-hidden transition-all duration-500 hover:border-white/20 bg-[#080808] w-full border-foreground/10 border relative">
                        {/* Background Abstract */}
                        ...
                        <div className="flex flex-col gap-4 pt-8 pr-8 pb-8 pl-8 absolute top-0 right-0 bottom-0 left-0 items-center justify-center">
                            <div className="flex gap-4">
                                <div className="w-16 h-16 bg-white/5 backdrop-blur-sm border border-foreground/10 flex items-center justify-center text-foreground shadow-2xl hover:bg-foreground/10 transition-colors">
                            ...
                            <div className="w-48 h-12 bg-white/5 backdrop-blur-sm border border-foreground/10 flex items-center justify-between px-3 shadow-2xl z-10">
                                <div className="w-8 h-8 bg-foreground/10 flex items-center justify-center text-foreground">
                    ...
                    <div className="mt-6 border-l border-foreground/10 pl-4">
                        <h3 className="text-sm text-foreground font-medium uppercase tracking-widest mb-2">Liquid Interface</h3>
                ...
                <div className="snap-center shrink-0 w-[300px] md:w-[360px] group cursor-default">
                    <div className="w-full aspect-[4/5] bg-[#080808] border border-foreground/10 overflow-hidden relative flex items-center justify-center transition-all duration-500 hover:border-white/20">
                        {/* Geometric Frame */}
                        <div className="w-[70%] h-[85%] border border-foreground/10 bg-[#030303] overflow-hidden relative shadow-2xl">
                            ...
                            <div className="absolute top-6 left-0 w-full flex flex-col items-center z-10 px-6">
                                ...
                                <span className="text-4xl font-light text-foreground tracking-tighter">09:41</span>
                            </div>
                    ...
                    <div className="mt-6 border-l border-foreground/10 pl-4">
                        <h3 className="text-sm text-foreground font-medium uppercase tracking-widest mb-2">Immersive Twin</h3>
                        <p className="text-neutral-500 font-light text-xs leading-relaxed max-w-[90%]">
                ...
                <div className="snap-center shrink-0 w-[300px] md:w-[360px] group cursor-default">
                    <div className="w-full aspect-[4/5] bg-[#080808] border border-foreground/10 overflow-hidden relative flex flex-col items-center justify-center transition-all duration-500 hover:border-white/20">
                        {/* Background Pattern */}
                        ...
                        {/* Notification Block */}
                        <div className="relative w-[85%] bg-[#050505] border border-foreground/10 p-6 shadow-2xl transform transition-transform duration-500 group-hover:-translate-y-1">
                            ...
                            <p className="text-sm text-foreground font-normal mb-2 tracking-tight">+1 (408) Load Shift</p>
                    ...
                    <div className="mt-6 border-l border-foreground/10 pl-4">
                        <h3 className="text-sm text-foreground font-medium uppercase tracking-widest mb-2">Auto Screening</h3>
                        <p className="text-neutral-500 font-light text-xs leading-relaxed max-w-[90%]">
                ...
                <div className="snap-center shrink-0 w-[300px] md:w-[360px] group cursor-default">
                    <div className="w-full aspect-[4/5] bg-[#080808] border border-foreground/10 overflow-hidden relative flex flex-col items-center justify-center transition-all duration-500 hover:border-white/20">
                        ...
                        <div className="relative w-full px-8">
                            <div className="text-center mb-8">
                                <h4 className="text-foreground font-normal uppercase tracking-widest text-xs">Remote Deploy</h4>
                                <div className="h-px w-12 bg-foreground/10 mx-auto my-3"></div>
                            ...
                            <div className="grid grid-cols-2 gap-px bg-white/5 border border-white/5 max-w-[200px] mx-auto">
                                ...
                                <div className="aspect-square bg-[#050505] hover:bg-white/5 transition-colors flex flex-col items-center justify-center gap-2 cursor-pointer group/btn">
                                    <iconify-icon icon="solar:satellite-bold-duotone" className="text-neutral-500 group-hover/btn:text-foreground text-xl transition-colors"></iconify-icon>
                                    <span className="text-[9px] text-neutral-600 font-medium uppercase tracking-widest">Scan</span>
                                </div>
                                {/* Btn 2 */}
                                <div className="aspect-square bg-[#050505] hover:bg-white/5 transition-colors flex flex-col items-center justify-center gap-2 cursor-pointer group/btn">
                                    <iconify-icon icon="solar:videocamera-record-bold-duotone" className="text-neutral-500 group-hover/btn:text-foreground text-xl transition-colors"></iconify-icon>
                                    <span className="text-[9px] text-neutral-600 font-medium uppercase tracking-widest">Feed</span>
                                </div>
                                {/* Btn 3 */}
                                <div className="aspect-square bg-[#050505] hover:bg-white/5 transition-colors flex flex-col items-center justify-center gap-2 cursor-pointer group/btn">
                                    <iconify-icon icon="solar:menu-dots-bold-duotone" className="text-neutral-500 group-hover/btn:text-foreground text-xl transition-colors"></iconify-icon>
                    ...
                    <div className="mt-6 border-l border-foreground/10 pl-4">
                        <h3 className="text-sm text-foreground font-medium uppercase tracking-widest mb-2">Site Assist</h3>
                        <p className="text-neutral-500 font-light text-xs leading-relaxed max-w-[90%]">
            ...
            {/* Navigation Controls */}
            <div className="absolute bottom-12 right-6 lg:right-12 flex gap-px border border-foreground/10 bg-[#080808]">
                <button className="w-12 h-12 flex items-center justify-center text-neutral-500 hover:text-foreground hover:bg-white/5 transition-all border-r border-foreground/10">
                    <iconify-icon icon="solar:arrow-left-linear" width="20"></iconify-icon>
                </button>
                <button className="w-12 h-12 flex items-center justify-center text-neutral-500 hover:text-foreground hover:bg-white/5 transition-all">
