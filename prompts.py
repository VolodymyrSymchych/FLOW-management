...
class PromptTemplates:
    """Collection of all prompt templates for analysis"""
    
    @staticmethod
    def main_analysis(project_name: str, project_type: str, industry: str, 
                     team_size: str, timeline: str, document: str) -> str:
        return f"""You are an expert Project Manager and Business Analyst with 15+ years of experience reviewing project requirements and identifying risks.
...
- Project Type: {project_type} (web app, mobile app, integration, etc.)
- Industry: {industry}
- Team Size: {team_size}
- Timeline: {timeline}
...
Be direct and actionable. Flag critical issues prominently."""
    ...
    def requirements_quality(document: str) -> str:
        return f"""Analyze each requirement using the INVEST criteria:
...
{document}"""
    ...
    def risk_assessment(document: str) -> str:
        return f"""You are a risk management expert. Analyze this project for potential risks.
...
- Immediate action items"""
    ...
    def technical_complexity(document: str) -> str:
        return f"""You are a Senior Software Architect. Analyze this project for hidden technical complexity.
...
- Risk level: Low/Medium/High"""
    ...
    def scope_creep_detector(document: str) -> str:
        return f"""Analyze this project for scope creep indicators.
...
Rewrite the scope with clear boundaries and exclusions."""
    ...
    def stakeholder_questions(document: str) -> str:
        return f"""Based on this project document, generate targeted questions for different stakeholders.
...
- Indicate if answer is "blocking" (must have before starting)"""
    ...
    def assumption_extractor(document: str) -> str:
        return f"""Identify all implicit and explicit assumptions in this project document.
...
- Recommended validation plan"""
    ...
    @staticmethod
    def format_report(analyses: dict, questions: str) -> str:
        return f"""Format the following analysis results into a comprehensive report.
